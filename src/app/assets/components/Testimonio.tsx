        ...
        <>
            ...
            <section className='z-10 relative flex flex-col gap-8 md:w-6/12 m-auto w-10/12'>
                <div className='z-10 flex flex-col gap-6'>
                    ...
                    <div className='uppercase bg-[#D9D9D9] bg-opacity-50 flex flex-col gap-4 py-8 text-center px-4 md:px-36'>
                ...
                <div className='z-10 uppercase bg-[#D9D9D9] bg-opacity-50 flex flex-col gap-4 py-8 text-center px-4 md:px-36'>
